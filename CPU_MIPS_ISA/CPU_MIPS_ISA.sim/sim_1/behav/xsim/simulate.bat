...
REM
REM Generated by Vivado on Mon Mar 10 13:01:59 -0400 2025
...
call xsim  control_unit_tb_behav -key {Behavioral:sim_1:Functional:control_unit_tb} -tclbatch control_unit_tb.tcl -log simulate.log
